...
<body>
	...
	try {
		...
		String sql = ("select  auction.aid, vehicles.minPrice, vehicles.itemName, vehicles.country, vehicles.power, vehicles.container, auction.curBid "
		+ "from auction "
	...
	<br>
		<form method="get" action="GetVehicle.jsp">
			<select name="sortby" size=1>
				<option value="mx">By Current Bid</option>
